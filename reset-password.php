                        ...
                        <div class="p-5">
                            ...
                            <form name="form" class="user" action="" method="POST">
                                <div class="form-group">
                                    <input type="password" class="form-control form-control-user" name="new" id=""
                                        placeholder="Masukan Password Baru..." maxlength="8" required>
                                </div>
                                <div class="form-group">
                                    <input type="password" class="form-control form-control-user" name="conf" id=""
                                        placeholder="Confirmasi Password Baru...">
                                </div>
                                <button class="btn btn-primary btn-user btn-block" type="submit" name="submit"
                                    onclick="return valid();">Reset Password</button>
                            </form>
                            <hr>
                            <div class="text-center">
